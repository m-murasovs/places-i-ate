...
- **Per-Visit Visibility** — Mark each visit public, followers-only, or private; profile visit lists and the "Friends also rated" feed hide visits the viewer isn't allowed to see
